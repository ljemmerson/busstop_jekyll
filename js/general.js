(function() {
  var $bio_close, $bio_trigger, $hash_links, $header, $mobile_trigger, animateNumber, animateValue, controller, scene;
  ...
  $mobile_trigger.on("click", function() {
    ...
    if (this.innerText === "Menu") {
      return this.innerText = "Close";
    } else {
      return this.innerText = "Menu";
    }
  });
  ...
  animateNumber = function(e) {
    if (e) {
      ...
      return animateValue("animated-value", 7500, 8000, 1000);
    }
  };
